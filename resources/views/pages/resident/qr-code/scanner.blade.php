            ...
            <form action="{{ route('health.store', $establishment->id) }}" method="POST" id="healthDec">
              ...
              <div class="form-row">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="q1Yes" name="q1" class="custom-control-input" value="Yes">
              ...
              <div class="form-row">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="q2Yes" name="q2" class="custom-control-input" value="Yes">
              ...
              <div class="form-row d-flex flex-column">
                ...
                <div class="form-row">
                  ...
                  <div class="col-5">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="feverYes" name="fever" class="custom-control-input" value="Yes">
                ...
                <div class="form-row">
                  ...
                  <div class="col-5">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="coughYes" name="cough" class="custom-control-input" value="Yes">
                  ...
                  <div class="col-5">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="runny_noseYes" name="runny_nose" class="custom-control-input" value="Yes">
                  ...
                  <div class="col-5">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="sore_throatYes" name="sore_throat" class="custom-control-input" value="Yes">
                  ...
                  <div class="col-5">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="shortness_of_breathYes" name="shortness_of_breath" class="custom-control-input" value="Yes">
              ...
              <strong class="text-danger">*If you answered ‘yes’ to any of the questions above, you are not allowed to enter the establishment</strong>
            </form>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="button" class="btn btn-primary" onclick="document.getElementById('healthDec').submit()">Submit</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="healthDec" tabindex="-1" role="dialog" aria-labelledby="healthDec" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ !empty($establishment->id) ? route('health.store', $establishment->id) : '#' }}" method="POST" id="healthForm">
            @csrf
            <p class="mb-0">You're Entering</p>
            <strong id="name">{{ !empty($establishment->information->company_name) ? $establishment->information->company_name : '' }}</strong><br>
            <small id="address">{{ !empty($establishment->information->company_address) ? $establishment->information->company_address : '' }}</small><br>
            <small id="date">{{ !empty($dateTime) ? $dateTime : '' }}</small>
            <hr>
            <div class="form-group row">
              <label for="temp" class="col-sm-2 col-form-label">Temperature</label>
              <div class="col-sm-10">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="button" class="btn btn-primary" onclick="document.getElementById('healthForm').submit()">Submit</button>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="modal-content bg-gradient-success">
        ...
        <div class="modal-body">
          <div class="py-3 text-center">
              ...
              <p>You're entering {{ $establishment->information->company_name }}</p>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-white" data-dismiss="modal">Ok, Got it</button>
